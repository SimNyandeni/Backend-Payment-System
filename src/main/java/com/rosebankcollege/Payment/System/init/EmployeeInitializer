...
public class EmployeeInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        createEmployeeIfNotExists("simphiwe.nyandeni@example.com", "Simphiwe Nyandeni", "Password@123");
        createEmployeeIfNotExists("kobus.smith@example.com", "Kobus Smith", "Securepass@123");
    }
